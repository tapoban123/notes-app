...
Built a Flutter app for creating, editing, searching, and deleting personal notes. Used GetX for state management, dependency injection, and routing. The app persists notes locally via SQLite and provides a smooth user experience with reactive UI updates.
...
- Used Flutter + Dart with GetX for state management and navigation
